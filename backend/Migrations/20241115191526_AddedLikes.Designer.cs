...
namespace MovieReviewApp.Migrations
{
    ...
    [Migration("20241115191526_AddedLikes")]
            ...
            modelBuilder.Entity("MovieReviewApp.Models.Review", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 11, 5, 14, 15, 25, 831, DateTimeKind.Local).AddTicks(6787),
                            Likes = 0,
                            MovieId = 1,
                            Rating = 5,
                            ReviewerName = "Alice",
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 11, 6, 14, 15, 25, 831, DateTimeKind.Local).AddTicks(6796),
                            Likes = 0,
                            MovieId = 1,
                            Rating = 5,
                            ReviewerName = "Bob",
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 11, 10, 14, 15, 25, 831, DateTimeKind.Local).AddTicks(6801),
                            Likes = 0,
                            MovieId = 2,
                            Rating = 2,
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 11, 13, 14, 15, 25, 831, DateTimeKind.Local).AddTicks(6806),
                            Likes = 0,
                            MovieId = 3,
                            Rating = 3,
                            ReviewerName = "Dave",
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 11, 14, 14, 15, 25, 831, DateTimeKind.Local).AddTicks(6811),
                            Likes = 0,
                            MovieId = 3,
                            Rating = 5,
                            ReviewerName = "Eve",
