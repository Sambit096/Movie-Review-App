...
namespace MovieReviewApp.Migrations
{
    ...
    [Migration("20241119193832_PendingModelChanges")]
            ...
            modelBuilder.Entity("MovieReviewApp.Models.Review", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 11, 9, 14, 38, 31, 541, DateTimeKind.Local).AddTicks(9120),
                            Likes = 0,
                            MovieId = 1,
                            Rating = 5,
                            ReviewerName = "Alice",
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 11, 10, 14, 38, 31, 541, DateTimeKind.Local).AddTicks(9620),
                            Likes = 0,
                            MovieId = 1,
                            Rating = 5,
                            ReviewerName = "Bob",
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 11, 14, 14, 38, 31, 541, DateTimeKind.Local).AddTicks(9620),
                            Likes = 0,
                            MovieId = 2,
                            Rating = 2,
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 11, 17, 14, 38, 31, 541, DateTimeKind.Local).AddTicks(9630),
                            Likes = 0,
                            MovieId = 3,
                            Rating = 3,
                            ReviewerName = "Dave",
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 11, 18, 14, 38, 31, 541, DateTimeKind.Local).AddTicks(9630),
                            Likes = 0,
                            MovieId = 3,
                            Rating = 5,
                            ReviewerName = "Eve",
