...
namespace MovieReviewApp.Migrations
{
    ...
    [Migration("20241128193323_UserChanges")]
            ...
            modelBuilder.Entity("MovieReviewApp.Models.Review", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 11, 18, 14, 33, 23, 258, DateTimeKind.Local).AddTicks(9706),
                            Likes = 0,
                            MovieId = 1,
                            Rating = 5,
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 11, 19, 14, 33, 23, 258, DateTimeKind.Local).AddTicks(9715),
                            Likes = 0,
                            MovieId = 4,
                            Rating = 5,
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 11, 23, 14, 33, 23, 258, DateTimeKind.Local).AddTicks(9721),
                            Likes = 0,
                            MovieId = 2,
                            Rating = 2,
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 11, 26, 14, 33, 23, 258, DateTimeKind.Local).AddTicks(9726),
                            Likes = 0,
                            MovieId = 3,
                            Rating = 3,
                            ReviewerName = "Dave",
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 11, 27, 14, 33, 23, 258, DateTimeKind.Local).AddTicks(9731),
                            Likes = 0,
                            MovieId = 3,
                            Rating = 5,
                            ReviewerName = "Eve",
