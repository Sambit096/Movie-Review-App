...
namespace MovieReviewApp.Migrations
{
    ...
    [Migration("20241204214944_cartUpdate")]
            ...
            modelBuilder.Entity("MovieReviewApp.Models.Review", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 11, 24, 16, 49, 43, 685, DateTimeKind.Local).AddTicks(5228),
                            Likes = 0,
                            MovieId = 1,
                            Rating = 5,
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 11, 25, 16, 49, 43, 685, DateTimeKind.Local).AddTicks(5233),
                            Likes = 0,
                            MovieId = 4,
                            Rating = 5,
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 11, 29, 16, 49, 43, 685, DateTimeKind.Local).AddTicks(5235),
                            Likes = 0,
                            MovieId = 2,
                            Rating = 2,
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 12, 2, 16, 49, 43, 685, DateTimeKind.Local).AddTicks(5237),
                            Likes = 0,
                            MovieId = 3,
                            Rating = 3,
                            ReviewerName = "Dave",
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 12, 3, 16, 49, 43, 685, DateTimeKind.Local).AddTicks(5240),
                            Likes = 0,
                            MovieId = 3,
                            Rating = 5,
                            ReviewerName = "Eve",
