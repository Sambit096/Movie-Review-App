...
namespace MovieReviewApp.Migrations
{
    ...
    [Migration("20241209041338_updateShowtimeModel")]
            ...
            modelBuilder.Entity("MovieReviewApp.Models.Review", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 11, 28, 23, 13, 37, 952, DateTimeKind.Local).AddTicks(1727),
                            Likes = 0,
                            MovieId = 1,
                            Rating = 5,
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 11, 29, 23, 13, 37, 952, DateTimeKind.Local).AddTicks(1741),
                            Likes = 0,
                            MovieId = 4,
                            Rating = 5,
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 12, 3, 23, 13, 37, 952, DateTimeKind.Local).AddTicks(1747),
                            Likes = 0,
                            MovieId = 2,
                            Rating = 2,
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 12, 6, 23, 13, 37, 952, DateTimeKind.Local).AddTicks(1754),
                            Likes = 0,
                            MovieId = 3,
                            Rating = 3,
                            ReviewerName = "Dave",
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 12, 7, 23, 13, 37, 952, DateTimeKind.Local).AddTicks(1760),
                            Likes = 0,
                            MovieId = 3,
                            Rating = 5,
                            ReviewerName = "Eve",
