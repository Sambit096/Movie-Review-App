    ...
    public class MovieReviewDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Ticket>().HasData(
                ...
                new Ticket { TicketId = 1, ShowTimeId = 1, Price = 12.5, Availability = true, CartId = null },
                new Ticket { TicketId = 2, ShowTimeId = 1, Price = 12.5, Availability = false, CartId = 1 },
                new Ticket { TicketId = 3, ShowTimeId = 2, Price = 14.0, Availability = true, CartId = null },
                ...
                new Ticket { TicketId = 6, ShowTimeId = 3, Price = 10.0, Availability = true, CartId = null },
                new Ticket { TicketId = 7, ShowTimeId = 4, Price = 15.0, Availability = true, CartId = null },
                ...
                new Ticket { TicketId = 10, ShowTimeId = 5, Price = 11.0, Availability = true, CartId = null },
                new Ticket { TicketId = 11, ShowTimeId = 5, Price = 11.0, Availability = false, CartId = 3 },
                new Ticket { TicketId = 12, ShowTimeId = 6, Price = 13.5, Availability = true, CartId = null },
                ...
                new Ticket { TicketId = 15, ShowTimeId = 7, Price = 12.0, Availability = true, CartId = null },
                new Ticket { TicketId = 16, ShowTimeId = 8, Price = 15.5, Availability = true, CartId = null },
                new Ticket { TicketId = 17, ShowTimeId = 8, Price = 15.5, Availability = false, CartId = 4 },
                new Ticket { TicketId = 18, ShowTimeId = 9, Price = 13.0, Availability = true, CartId = null },
                new Ticket { TicketId = 19, ShowTimeId = 9, Price = 13.0, Availability = false, CartId = 5 },
                new Ticket { TicketId = 20, ShowTimeId = 10, Price = 16.0, Availability = true, CartId = null },
                new Ticket { TicketId = 21, ShowTimeId = 10, Price = 16.0, Availability = false, CartId = 1 },
                new Ticket { TicketId = 22, ShowTimeId = 11, Price = 14.5, Availability = true, CartId = null },
                new Ticket { TicketId = 23, ShowTimeId = 11, Price = 14.5, Availability = false, CartId = 2 },
                new Ticket { TicketId = 24, ShowTimeId = 12, Price = 10.5, Availability = true, CartId = null },
                new Ticket { TicketId = 25, ShowTimeId = 12, Price = 10.5, Availability = false, CartId = 5 },
                new Ticket { TicketId = 26, ShowTimeId = 13, Price = 11.0, Availability = true, CartId = null },
                new Ticket { TicketId = 27, ShowTimeId = 14, Price = 12.0, Availability = true, CartId = null },
                ...
                new Ticket { TicketId = 30, ShowTimeId = 15, Price = 13.0, Availability = true, CartId = null },
                new Ticket { TicketId = 31, ShowTimeId = 15, Price = 13.0, Availability = false, CartId = 5 }
            );
            modelBuilder.Entity<Cart>().HasData(
                new Cart { CartId = 1, UserId = 1, Total = 56.5 },
                new Cart { CartId = 2, UserId = 2, Total = 44.5 },
                new Cart { CartId = 3, UserId = 3, Total = 11.0 },
                new Cart { CartId = 4, UserId = 4, Total = 42.5 },
                new Cart { CartId = 5, UserId = 5, Total = 60.5 }
            );
            ...
            modelBuilder.Entity<Review>().HasData(
                ...
                new Review { ReviewId = 3, MovieId = 2, UserId = 2, Content = "Great for kids and adults alike.", ReviewerName = "janesmith", CreatedAt = DateTime.Now.AddDays(-5), Rating = 2 },
                new Review { ReviewId = 4, MovieId = 3, UserId = 3, Content = "A compelling story about loyalty and power.", ReviewerName = "mikejones", CreatedAt = DateTime.Now.AddDays(-2), Rating = 3 },
                new Review { ReviewId = 5, MovieId = 3, UserId = 4, Content = "One of the best films ever made.", ReviewerName = "sconnor", CreatedAt = DateTime.Now.AddDays(-1), Rating = 5 }
            );
